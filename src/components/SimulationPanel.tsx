          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3 text-sm">
              <div className="text-muted-foreground">
                耗时：<span className="font-medium text-foreground">{result.elapsed.toFixed(0)} ms</span>
              </div>
            ...
            {/* 前 10 名胜场 Badges */}
            <div>
              <p className="text-xs text-muted-foreground mb-2">前 10 名胜场数：</p>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {result.winDistribution.map((count, w) => (
                  <div
                    key={w}
                    className="text-xs rounded px-2 py-0.5 bg-muted/60 border"
                  >
                    <span className="font-medium">{w}胜</span>
